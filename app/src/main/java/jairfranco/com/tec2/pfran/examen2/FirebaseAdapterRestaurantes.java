 ...
 */
public abstract class FirebaseAdapterRestaurantes <ViewHolder extends RecyclerView.ViewHolder, T>
        extends RecyclerView.Adapter<ViewHolder> {

    private Query mQuery;
    private Class<Restaurant> mItemClass;
     ...
     */
    public FirebaseAdapterRestaurantes(Query query, Class<Restaurant> itemClass) {
     ...
     */
    public FirebaseAdapterRestaurantes(Query query, Class<Restaurant> itemClass,
                                   @Nullable ArrayList<Restaurant> items,
        ...
        if (items != null && keys != null) {
            ...
            mItems = new ArrayList<Restaurant>();
    ...
    private ChildEventListener mListener = new ChildEventListener() {
        ...
        public void onChildAdded(DataSnapshot dataSnapshot, String previousChildName) {
            ...
            if (!mKeys.contains(key)) {
                Restaurant item = dataSnapshot.getValue(FirebaseAdapterRestaurantes.this.mItemClass);
                ...
                if (previousChildName == null) {
                    ...
                    if (nextIndex == mItems.size()) {
                        mItems.add(item);
                        Collections.sort(mItems, (o1, o2) -> o1.getsName().compareTo(o2.getsName()));
        ...
        public void onChildChanged(DataSnapshot dataSnapshot, String s) {
            ...
            if (mKeys.contains(key)) {
                ...
                Restaurant oldItem = mItems.get(index);
                Restaurant newItem = dataSnapshot.getValue(FirebaseAdapterRestaurantes.this.mItemClass);
        ...
        public void onChildRemoved(DataSnapshot dataSnapshot) {
            ...
            if (mKeys.contains(key)) {
                int index = mKeys.indexOf(key);
                Restaurant item = mItems.get(index);
    ...
    protected FirebaseAdapterRestaurantes() {
    }
     ...
     */
    public int getPositionForItem(Restaurant item) {
     ...
     */
    public boolean contains(Restaurant item) {
     ...
     */
    protected abstract void itemAdded(Restaurant item, String key, int position);
     ...
     */
    protected abstract void itemChanged(Restaurant oldItem, Restaurant newItem, String key, int position);
     ...
     */
    protected abstract void itemRemoved(Restaurant item, String key, int position);
     ...
     */
    protected abstract void itemMoved(Restaurant item, String key, int oldPosition, int newPosition);
